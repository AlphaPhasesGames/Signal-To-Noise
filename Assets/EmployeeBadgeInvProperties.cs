...
{
    public class EmployeeBadgeInvProperties : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public TextMeshProUGUI badgeName; //TMP text to appear at bottom of inv for gold item
        ...
        public Button badgeButton; // this button holds the image for the gold item when in inventory
        ...
        public bool badgeHeld;

        // Start is called before the first frame update
        private void Start()
        {
            digiWaveMain = FindObjectOfType<TUSOMMain>();
            badgeButton.onClick.AddListener(TurnOnAndOff); // add listener to button for gold item
        }
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            badgeName.gameObject.SetActive(true); // show text for gold item
            Debug.Log("Mouse is over GameObject.");
        }
        public void OnPointerExit(PointerEventData eventData)
        {
            //If your mouse hovers over the GameObject with the script attached, output this message and execute code
            badgeName.gameObject.SetActive(false); // hide text for gold item
