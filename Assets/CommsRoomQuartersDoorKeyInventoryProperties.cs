...
{
    public class CommsRoomQuartersDoorKeyInventoryProperties : MonoBehaviour
    {
        ...
        public TextMeshProUGUI doorKeyName; //TMP text to appear at bottom of inv for gold item
        public bool playerPickedUpObject; // bool to check is the player has oicked up the item
        public bool playerHasDoorKeyObject;
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            doorKeyName.gameObject.SetActive(true); // show text for gold item
            Debug.Log("Mouse is over GameObject.");
        }
        public void OnPointerExit(PointerEventData eventData)
        {
            //If your mouse hovers over the GameObject with the script attached, output this message and execute code
            doorKeyName.gameObject.SetActive(false); // hide text for gold item
